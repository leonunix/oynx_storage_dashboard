...
type Handlers struct {
	UserStore      *auth.BootstrapUserStore
...
func (h *Handlers) Login(w http.ResponseWriter, r *http.Request) {
	...
	h.AuditService.Record(user.Username, "auth.login", "dashboard", "success", "bootstrap user login")
...
func (h *Handlers) ListAuditEvents(w http.ResponseWriter, _ *http.Request) {
	writeJSON(w, http.StatusOK, map[string]any{"items": h.AuditService.List()})
}
